<script>
    ...
    onMount(() => {
        bootSound = new Audio('protie.opus');
    });
    ...
    function startBoot() {
        ...
        if (loop == false) {
            loop = true;
            document.querySelector('.proto-face').style.animationDuration = '2s';
            setInterval(() => {
                hue = (hue + 1) % 360;
...
<div class="hero">
    <h1>Boop to chat with Protie:</h1>
...
<div class="proto-face-holder flicker-in">
    ...
    >
        <path id="proto-eyes"
            ...
            d="m 234.38608,240.37577 c 64.23546,-77.18025 211.34696,-102.97062 275.3641,96.70157 -132.97423,17.63342 -250.08281,-54.825 -275.3641,-96.70157 z m 811.22782,0 c -64.23543,-77.18025 -211.34693,-102.97062 -275.36407,96.70157 132.97423,17.63342 250.08277,-54.825 275.36407,-96.70157 z"/>
        <path id="proto-mouth"

  ...
  <div class="service">
    <div class="service-header">
      ...
      <a class="serice-status" href="https://status.protogen.chat"
        ><img
          src="https://status.protogen.chat/api/badge/7/status"
          alt="pds status indicator"
        /></a
      >
      -->
    </div>
  ...
  <div class="service">
    <div class="service-header">
      <svg
        ...
        /></svg
      >
      <a href="https://git.protogen.chat"
        ><h2 class="service-name">Forgejo</h2></a
      >
      <!--moved from uptime kuma to hetrix, need to find a new way to do badges
      <a class="serice-status" href="https://status.protogen.chat"
        ><img
          style="object-fit: cover;"
          src="https://status.protogen.chat/api/badge/1/status"
          alt="forgejo status indicator"
        /></a
      >
      -->
    </div>
    <hr />
    <p>
      A self-hosted GitHub alternative, hopefully federated one day with <a
        href="https://forgefed.org/">ForgeFed</a
      >. A basic runner is available to use as well.
    </p>
  </div>
  <div class="service">
    <div class="service-header">
      ...
      <a href="https://knot.protogen.chat"><h2 class="service-name">Knot</h2></a
      >
      <!--moved from uptime kuma to hetrix, need to find a new way to do badges
      <a class="serice-status" href="https://status.protogen.chat"
        ><img
          style="object-fit: cover;"
          src="https://status.protogen.chat/api/badge/11/status"
          alt="knot status indicator"
        /></a
      >
      -->
    </div>
    <hr />
    <p>
      This hosts repository data and handles Git operations for <a
        href="https://tangled.org">tangled</a
      > repos.
    </p>
  </div>
  <div class="service">
    <div class="service-header">
      <svg
        role="img"
        class="service-icon"
        viewBox="0 0 67.733334 67.733329"
        xmlns="http://www.w3.org/2000/svg"
      >
        <title>Webring</title>
        <path

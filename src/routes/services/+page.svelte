...
<div class="service-grid">
  ...
  <div class="service">
    <div class="service-header">
      <svg role="img" class="service-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
        ...
        /></svg
      >
      <h2 class="service-name"><a href="https://git.protogen.chat">Forgejo</a></h2>
      <!--moved from uptime kuma to hetrix, need to find a new way to do badges
      <a class="serice-status" href="https://status.protogen.chat"
        ><img
          style="object-fit: cover;"
  ...
  <div class="service">
    <div class="service-header">
      ...
      <h2 class="service-name"><a href="/webring">ProtogenRing</a></h2>
    </div>
    <hr />
    <p>
  ...
  <div class="service">
    ...
    <p>Wafrn? - maybe, a lotta factors</p>
  </div>
</div>
